...
You can add, remove, and edit users of your Astra Control Center installation using the Astra Control Center UI. You can use the Astra UI or https://docs.netapp.com/us-en/astra-automation-2108/index.html[the Astra API^] to manage users.
...
. When you're prompted, confirm deletion by typing the word "remove" and then click *Yes, Remove User*.
